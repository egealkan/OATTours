...
//   // Days with their places, sorted chronologically
//   const [itineraryByDay, setItineraryByDay] = useState([]); // [{ dayNumber, date, places: [name, ...] }]
...
//       // Fetch days + places grouped by day
...
//             places: dayPlaces
//           };
//         }).filter(d => d.places.length > 0); // only show days that have places
...
//       {/* ── Our Itinerary Card (places by day) ── */}
...
//                         {day.date && (
//                           <span className="itinerary-day-date">{formatUSDate(day.date)}</span>
//                         )}
//                       </div>
